...
(1, 1, '2025-10-15 10:00:00', 'Checkup', 'Completed'),
(1, 2, '2025-11-01 14:30:00', 'Flu Shot', 'Completed'),
(2, 2, '2025-10-20 09:00:00', 'Consultation', 'Completed'),
(3, 4, '2026-12-05 11:00:00', 'Therapy', 'Scheduled'),
(4, 2, '2025-11-10 15:00:00', 'Checkup', 'Completed'),
(1, 1, '2026-12-01 10:00:00', 'Follow-up', 'Scheduled'),
(2, 3, '2026-12-10 13:00:00', 'Skin Check', 'Scheduled');

-- Insert WellnessChallenges
INSERT INTO WellnessChallenges (creator_id, name, description, start_date, end_date) VALUES 
(1, '10k Steps Daily', 'Walk 10,000 steps every day for a month', '2025-11-01', '2026-11-30'),
(2, 'No Sugar November', 'Avoid added sugar for the whole month', '2025-11-01', '2026-11-30'),
(3, 'Yoga Morning', 'Do 20 mins of yoga every morning', '2025-12-01', '2026-12-31');
